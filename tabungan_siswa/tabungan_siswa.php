...
?>
    	...
    	<tr>
            ...
            <td><a class="btn btn-danger btn-xs" href="index.php?pilih=1.5&aksi=viewambil&kode_tabungan=<?php echo $data['kode_tabungan'];?>&nis=<?php echo $d;?>"> Ambil Uang</a>
              
            <a class="btn btn-warning btn-xs" href="index.php?pilih=1.5&aksi=simpanansiswa&nis=<?php echo $data['nis'];?>&nis=<?php echo $d;?>">Simpan Uang</a>
...
?>
	<div id="page-wrapper">
            <div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<form class="form-horizontal" action="tabungan_siswa/aksi-proses-simpan.php?pros=simpan" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" name="nis" title="NIS harus diisi" readonly="" class="form-control" value="<?php echo $data2['nis'];?>">
										</div>
									</div>
            ...
            <input type="text" name="user_entry" class="form-control"  value="<?php session_start(); echo $_SESSION['name'];?>" readonly >
										</div>
									</div>
									<div class="form-group">
...
{ $lo=$_GET['kode_tabungan'];$luy=$_GET['nis'];$nama=mysql_fetch_array(mysql_query("SELECT nama_siswa from tb_siswa where nis='$luy'")); ?>
 ...
 <div class="col-lg-12">
  <div class="form-panel">
   ...
   <span style="float:right;">
<form action="tabungan_siswa/aksi-proses-tabungan.php" method="get">
<input type="hidden" value="<?php echo $lo; ?>" name="kode_tabungan"> <input type="hidden" value="<?php echo $luy; ?>" name="nis"> 
<?php $rtyu=mysql_fetch_array(mysql_query("SELECT *FROM tb_tabungansiswa where kode_tabungan='$lo' and nis='$luy'")); ?>
