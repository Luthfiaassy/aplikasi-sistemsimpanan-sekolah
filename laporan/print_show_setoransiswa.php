...
$pdf->Cell(25.2,0.7,"Laporan Setoran Siswa ".$nama['nama_siswa']."",0,10,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
...
$query = mysql_query("SELECT * from tb_setorsiswa where nis='$kode'");
$no=1;
...
$hasil=mysql_fetch_array(mysql_query("SELECT sum(besar_simpanan) as besar from tb_setorsiswa where nis='$kode'"));
$pdf->Cell(15, 0.8, 'Total', 1, 0, 'C');
$pdf->Cell(8, 0.8, number_format($hasil['besar']), 1, 0, 'C');

$pdf->Output("Laporan setoran Siswa.pdf","I");
