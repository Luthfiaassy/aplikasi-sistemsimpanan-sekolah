...
$pdf->Cell(25.2,0.7,"Laporan Tabungan Siswa",0,10,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
...
$pdf->Cell(5, 0.8, 'No Induk Siswa', 1, 0, 'C');
...
$no++;}
$pdf->Output("Laporan Seluruh tabungan siswa.pdf","I");
