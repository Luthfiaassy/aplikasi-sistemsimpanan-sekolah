...
$pdf->Cell(25.2,0.7,"Laporan Penarikan Siswa ".$nama['nama_siswa']."",0,10,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
...
$query = mysql_query("SELECT * from  tb_pengambilansiswa where nis='$luy'");
$no=1;
...
$hasil=mysql_fetch_array(mysql_query("SELECT sum(besar_ambil) as besar from tb_pengambilansiswa where nis='$luy'"));
$pdf->Cell(15, 0.8, 'Total', 1, 0, 'C');
$pdf->Cell(8, 0.8, number_format($hasil['besar']), 1, 0, 'C');

$pdf->Output("Laporan Penarikan Siswa.pdf","I");
